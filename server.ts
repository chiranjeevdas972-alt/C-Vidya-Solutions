...
function getFallbackReply(messages: any[]): string {
  ...
  let reply = "Hello! 👋 Welcome to C Vidya Solutions.\n\nI am your AI Customer Support Assistant. I can help you learn about our software solutions, features, demos, support, and business services.\n\nHow can I help you today?";

  if (userText.includes("human") || userText.includes("person") || userText.includes("real agent")) {
    reply = "I am the AI Customer Support Assistant of C Vidya Solutions. I can help you with information about our software, services, demos, and support. If you'd like to connect with a human representative, please share your contact details and software requirements, and our team will get in touch!";
  } else if (userText.includes("demo")) {
    reply = "Thank you for your interest in C Vidya Solutions. I can help you request a product demo.\n\nPlease share:\n1. Full Name\n2. Business or Organization Name\n3. Mobile Number\n4. Email Address\n5. Interested Software Product\n6. City and State\n7. Preferred Demo Date or Time\n\nOur team can review your request and contact you regarding the demo!";
  } else if (userText.includes("price") || userText.includes("cost") || userText.includes("rate") || userText.includes("fee") || userText.includes("plan")) {
    reply = "Pricing may depend on the selected software, required modules, number of users, customization requirements, and business needs.\n\nPlease share the software you are interested in and your requirements. Our C Vidya Solutions team can provide the appropriate pricing details!";
  } else if (userText.includes("website") || userText.includes("site") || userText.includes("link") || userText.includes("url")) {
    reply = "You can visit the official C Vidya Solutions website at:\nhttps://cvidyasolutions.com";
  } else if (userText.includes("library") || userText.includes("book") || userText.includes("reading")) {
    reply = "C Vidya Library Management System helps libraries reduce manual work, organize records, manage students and books efficiently, and monitor daily operations from one platform.\n\nKey features: Student management, Book issue/return, Seat tracking, Fee records, and Invoices. Would you like to request a demo?";
  } else if (userText.includes("gym") || userText.includes("fitness") || userText.includes("workout")) {
    reply = "CV Fitness Zone helps gym owners manage members, memberships, payments, attendance, and daily operations more efficiently. Would you like to request a demo?";
  } else if (userText.includes("school") || userText.includes("institute") || userText.includes("coaching") || userText.includes("tuition") || userText.includes("batch")) {
    reply = "Our Institute and Coaching Management Software helps educational institutes and coaching centers manage students, fees, attendance, batches, and daily operations in one organized system.";
  } else if (userText.includes("chickmart") || userText.includes("poultry shop") || userText.includes("chicken")) {
    reply = "ChickMart helps poultry businesses organize inventory, sales, customers, expenses, and business records in one digital platform.";
  } else if (userText.includes("farmfresh") || userText.includes("farm fresh") || userText.includes("agriculture")) {
    reply = "FarmFresh Hub helps farm owners manage different farming activities, inventory, sales, expenses, and business records from one platform.";
  } else if (userText.includes("agrifusion") || userText.includes("farm") || userText.includes("goat") || userText.includes("fish")) {
    reply = "AgriFusion ('One Platform. Every Farm. Unlimited Growth.') helps farmers manage multiple farming operations—poultry, goat, fish, egg production, and inventory—from one platform.";
  } else if (userText.includes("support") || userText.includes("login") || userText.includes("error") || userText.includes("password") || userText.includes("otp") || userText.includes("problem")) {
    reply = "To assist with technical support, please share:\n1. Software Product Name\n2. Registered Email or Mobile Number\n3. Error Message\n4. Device Type (Mobile/Laptop/Desktop)\n5. Steps followed before the issue occurred\n\n*Security Note: Never share your password, OTP, or PIN.*";
  } else if (userText.includes("contact") || userText.includes("phone") || userText.includes("email") || userText.includes("address") || userText.includes("office")) {
    reply = "You can reach C Vidya Solutions through:\n- Official Website: https://cvidyasolutions.com\n- Phone: 8987766981\n- Email: cvidyasolutions@gmail.com\n- Director (Chiranjeev Das): chiranjeev0058@gmail.com\n- HQ: Surunga, Baliapur, Dhanbad, Jharkhand - 828115\n- Branch: STPI Sindri, BIT Sindri Campus, Dhanbad, Jharkhand";
  }
